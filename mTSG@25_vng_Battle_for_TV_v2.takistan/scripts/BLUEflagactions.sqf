...
{
    {
        ...
        {},
        {_target setVariable ["controledBy", west, true]; [_target, "pics\atk.paa"] remoteExec ["forceFlagTexture", _target]; [_target, 1] call BIS_fnc_animateFlag; ["Игрок: %1 атаки поднял флаг!", name player] call delpan_fnc_messageReplay;},
...
{
    {
        ...
        {[_target, 0] call BIS_fnc_animateFlag},
        {},
        {_target setVariable ["controledBy", east, true]; [_target, "pics\def.paa"] remoteExec ["forceFlagTexture", _target]; [_target, 1] call BIS_fnc_animateFlag; ["Игрок: %1 обороны поднял флаг!", name player] call delpan_fnc_messageReplay;},
        {[_target, 1] call BIS_fnc_animateFlag;},
        [],20,0,false,false] call BIS_fnc_holdActionAdd;
    } forEach flags;
};